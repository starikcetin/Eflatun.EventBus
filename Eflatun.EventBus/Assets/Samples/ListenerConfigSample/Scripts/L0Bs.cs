...
{
    public class L0Bs : MonoBehaviour
    {
        ...
        {
            var listenerConfig = ListenerConfig.SingleChannelAndBroadcast(0, ListenPhase.Regular);
        ...
        {
            Debug.Log($"{metadata.Sender.GetType().Name}\t->\t{nameof(L0Bs)}");
        }
    }
}
